...
function Register() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      sessionStorage.setItem("cravio_otp_email", data.email.trim().toLowerCase());
  ...
  return (
    <div className="min-h-screen w-full bg-white text-[#17233b] flex flex-col">
      <header className="w-full h-[68px] md:h-[72px] flex items-center justify-between px-6 sm:px-8 md:px-12">
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="text-[17px] md:text-[18px] font-semibold text-cravio tracking-tight"
          >
            Cravio
          </button>
        </div>
      ...
      <main className="w-full flex-1 flex justify-center">
        <div className="w-full max-w-[430px] px-6 sm:px-8 pt-10 sm:pt-12 md:pt-[54px] pb-12">
          <div className="w-full flex flex-col items-center text-center mb-7">
            <h2 className="whitespace-nowrap text-[20px] sm:text-[23px] md:text-[27px] leading-tight tracking-[-0.5px] font-bold text-heading">
              Your next favorite meal is waiting.
            </h2>

            <p className="mt-2.5 text-[12px] sm:text-[13px] leading-5 text-subheading">
          ...
          <form className="w-full" onSubmit={handleSubmit(onSubmit)}>
            <div>
              <input
                ...
                className={`w-full h-[44px] px-4 rounded-lg border bg-white outline-none text-[13px] text-heading placeholder:text-gray-400 transition-all duration-200 hover:border-gray-400 focus:border-cravio focus:ring-1 focus:ring-cravio ${
                  errors.username
            ...
            <div className="relative mt-3">
              ...
              <input
                ...
                className={`w-full h-[44px] pl-4 pr-10 rounded-lg border bg-white outline-none text-[13px] text-heading placeholder:text-gray-400 transition-all duration-200 hover:border-gray-400 focus:border-cravio focus:ring-1 focus:ring-cravio ${
                  errors.email
                    ? "border-red-500 focus:border-red-500 focus:ring-red-500"
                    : "border-[#d5d8de]"
                }`}
            ...
            <div className="relative mt-3">
              <input
                ...
                className={`w-full h-[44px] px-3.5 pr-11 rounded-lg border bg-white outline-none text-[13px] text-heading placeholder:text-gray-400 transition-all duration-200 hover:border-gray-400 focus:border-cravio focus:ring-1 focus:ring-cravio ${
                  errors.password
                    ? "border-red-500 focus:border-red-500 focus:ring-red-500"
                    : "border-[#d5d8de]"
                }`}
              ...
              <button
                ...
                className="absolute right-3.5 top-1/2 -translate-y-1/2 flex items-center justify-center text-gray-400 hover:text-cravio transition-colors duration-200"
            ...
            <div className="mt-3 flex items-center justify-center gap-1 text-[11px] sm:text-[12px] text-[#777]">
              <span className="text-cravio font-semibold">
                Get up to 10 forks
              </span>
          ...
          <button
            type="button"
            className="group relative w-full h-[46px] rounded-full bg-[#f5f5f6] hover:bg-[#eeeeef] hover:-translate-y-[1px] active:translate-y-0 transition-all duration-200 flex items-center justify-center text-[13px] font-medium text-[#17233b]"
          >
          ...
          <div className="text-center mt-5">
            <p className="text-[11px] md:text-[12px] text-subheading">
              Have an account?{" "}
              <button
                type="button"
                onClick={() => navigate("/login")}
                className="font-medium text-cravio hover:underline underline-offset-2 transition-all duration-200"
              >
                Login now
              </button>
            </p>
